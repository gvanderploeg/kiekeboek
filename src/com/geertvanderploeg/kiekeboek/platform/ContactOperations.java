...
public class ContactOperations {
     ...
     * @return instance of ContactOperations
     */
    public ContactOperations addName(String firstName, String middleName, String lastName, String displayName) {
        mValues.clear();
     ...
     * @return instance of ContactOperations
     */
    public ContactOperations addAddress(String street, String postcode, String city) {
        mValues.clear();
    ...
    public ContactOperations addProfileAction(long userId) {
        mValues.clear();
        if (userId != 0) {
            mValues.put(KiekeboekColumns.DATA_PID, userId);
            mValues.put(KiekeboekColumns.DATA_SUMMARY, mContext.getString(R.string.profile_action));
            mValues.put(KiekeboekColumns.DATA_DETAIL, mContext.getString(R.string.view_profile));
            mValues.put(Data.MIMETYPE, Constants.KIEKEBOEK_MIMETYPE);
            addInsertOp();
        }
        return this;
    }
    ...
    public ContactOperations addPicture(byte[] photoData) {
        mValues.clear();
        mValues.put(Photo.PHOTO, photoData);
