...
public class AuthenticatorActivity extends AccountAuthenticatorActivity {
  ...
  */
    ...
    protected Dialog onCreateDialog(int id) {
        ...
        dialog.setMessage(getText(R.string.ui_login_activity_authenticating));
    ...
    protected void finishConfirmCredentials(boolean result) {
        ...
        final Account account = new Account(mUsername + "@" + getText(R.string.label), Constants.ACCOUNT_TYPE);
    ...
    private void declareInGroups(final Account account) {
        try {
            ...
            Log.e(TAG, "Exception occurred while declaring account in groups: " + e.getMessage(), e);
        }
    }
